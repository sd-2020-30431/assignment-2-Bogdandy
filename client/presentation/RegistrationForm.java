...
public class RegistrationForm extends javax.swing.JFrame {
    ...
    public void serverPass(ObjectInputStream objectInputStream,  ObjectOutputStream objectOutputStream) throws IOException{
    ...
    private void signUpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signUpButtonActionPerformed
        String command = "SignUp "+ usernameField.getText() +" "+ passwordField.getText() +" "+ 
               emailAddressField.getText() +" "+ phoneNumberField.getText()+" "+ verificatePasswordField.getText(); 
